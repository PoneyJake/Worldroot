...
(function () {
  ...
  Object.assign(C, {
    ...
    CRAFT_RECIPES: [
      { id: 'material_pouch_2', output: 'material_pouch_2', costs: [{ res: 'twine', amt: 5 }, { res: 'oak', amt: 10 }] },
      { id: 'material_pouch_3', output: 'material_pouch_3', costs: [{ res: 'wooden_pegs', amt: 10 }, { res: 'spruce', amt: 20 }] },
      { id: 'material_pouch_4', output: 'material_pouch_4', costs: [{ res: 'iron_nails', amt: 15 }, { res: 'birch', amt: 30 }] },
      { id: 'material_pouch_5', output: 'material_pouch_5', costs: [{ res: 'resin', amt: 20 }, { res: 'jungle', amt: 40 }] },
      { id: 'material_pouch_6', output: 'material_pouch_6', costs: [{ res: 'resin', amt: 50 }, { res: 'platinum_bar', amt: 10 }] },
      { id: 'mining_pouch_2', output: 'mining_pouch_2', costs: [{ res: 'copper', amt: 25 }, { res: 'copper_bar', amt: 5 }] },
      { id: 'mining_pouch_3', output: 'mining_pouch_3', costs: [{ res: 'iron', amt: 40 }, { res: 'iron_bar', amt: 10 }] },
      { id: 'mining_pouch_4', output: 'mining_pouch_4', costs: [{ res: 'gold', amt: 60 }, { res: 'gold_bar', amt: 15 }] },
      { id: 'mining_pouch_5', output: 'mining_pouch_5', costs: [{ res: 'platinum', amt: 80 }, { res: 'platinum_bar', amt: 20 }] },
      { id: 'mining_pouch_6', output: 'mining_pouch_6', costs: [{ res: 'platinum_bar', amt: 50 }, { res: 'gold_bar', amt: 50 }] },
      { id: 'woodcutting_pouch_2', output: 'woodcutting_pouch_2', costs: [{ res: 'oak', amt: 25 }, { res: 'spruce', amt: 10 }] },
      { id: 'woodcutting_pouch_3', output: 'woodcutting_pouch_3', costs: [{ res: 'spruce', amt: 40 }, { res: 'birch', amt: 15 }] },
      { id: 'woodcutting_pouch_4', output: 'woodcutting_pouch_4', costs: [{ res: 'birch', amt: 60 }, { res: 'jungle', amt: 20 }] },
      { id: 'woodcutting_pouch_5', output: 'woodcutting_pouch_5', costs: [{ res: 'jungle', amt: 80 }, { res: 'resin', amt: 15 }] },
      { id: 'woodcutting_pouch_6', output: 'woodcutting_pouch_6', costs: [{ res: 'jungle', amt: 150 }, { res: 'resin', amt: 40 }] },
      { id: 'fishing_pouch_2', output: 'fishing_pouch_2', costs: [{ res: 'shrimp', amt: 25 }, { res: 'trout', amt: 10 }] },
      { id: 'fishing_pouch_3', output: 'fishing_pouch_3', costs: [{ res: 'trout', amt: 40 }, { res: 'salmon', amt: 15 }] },
      { id: 'fishing_pouch_4', output: 'fishing_pouch_4', costs: [{ res: 'salmon', amt: 60 }, { res: 'lobster', amt: 20 }] },
      { id: 'fishing_pouch_5', output: 'fishing_pouch_5', costs: [{ res: 'lobster', amt: 80 }, { res: 'salmon', amt: 40 }] },
      { id: 'fishing_pouch_6', output: 'fishing_pouch_6', costs: [{ res: 'lobster', amt: 150 }, { res: 'platinum_bar', amt: 5 }] },
    ],
