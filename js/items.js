...
(function () {
  ...
  Object.assign(C, {
    ...
    CRAFT_RECIPES: [
      { id: 'material_pouch_2', output: 'material_pouch_2', costs: [{ res: 'twine', amt: 50 }, { res: 'slime_gel', amt: 50 }] },
      { id: 'material_pouch_3', output: 'material_pouch_3', costs: [{ res: 'wooden_pegs', amt: 250 }, { res: 'wisp_essence', amt: 250 }] },
      { id: 'material_pouch_4', output: 'material_pouch_4', costs: [{ res: 'iron_nails', amt: 1000 }, { res: 'gloomspore', amt: 750 }, { res: 'bat_wing_membrane', amt: 750 }] },
      { id: 'material_pouch_5', output: 'material_pouch_5', costs: [{ res: 'resin', amt: 5000 }, { res: 'leech_sucker', amt: 2500 }, { res: 'moth_pollen', amt: 2500 }] },
      { id: 'mining_pouch_2', output: 'mining_pouch_2', costs: [{ res: 'copper', amt: 50 }] },
      { id: 'mining_pouch_3', output: 'mining_pouch_3', costs: [{ res: 'iron', amt: 500 }] },
      { id: 'mining_pouch_4', output: 'mining_pouch_4', costs: [{ res: 'gold', amt: 2000 }] },
      { id: 'mining_pouch_5', output: 'mining_pouch_5', costs: [{ res: 'platinum', amt: 7500 }] },
      { id: 'woodcutting_pouch_2', output: 'woodcutting_pouch_2', costs: [{ res: 'oak', amt: 50 }] },
      { id: 'woodcutting_pouch_3', output: 'woodcutting_pouch_3', costs: [{ res: 'spruce', amt: 500 }] },
      { id: 'woodcutting_pouch_4', output: 'woodcutting_pouch_4', costs: [{ res: 'birch', amt: 2000 }] },
      { id: 'woodcutting_pouch_5', output: 'woodcutting_pouch_5', costs: [{ res: 'jungle', amt: 7500 }] },
      { id: 'fishing_pouch_2', output: 'fishing_pouch_2', costs: [{ res: 'shrimp', amt: 50 }] },
      { id: 'fishing_pouch_3', output: 'fishing_pouch_3', costs: [{ res: 'trout', amt: 500 }] },
      { id: 'fishing_pouch_4', output: 'fishing_pouch_4', costs: [{ res: 'salmon', amt: 2000 }] },
      { id: 'fishing_pouch_5', output: 'fishing_pouch_5', costs: [{ res: 'lobster', amt: 7500 }] },
    ],
