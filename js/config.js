...
window.WorldrootConfig = {
  ...
  GATHER_MIN_EFFICIENCY: 10,
  GATHER_EFF_PER_TIER: 40,
  ...
  WORLD_TREE_BRANCHES: [
    {
      ...
      nodes: [
        ...
        { id: 'base_mp', name: '+ Base MP', effect: 'base_mp', bonusType: 'flat', desc: 'Increases base mana', costRes: 'goblin_ear', baseCost: 15 },
        ...
        { id: 'pct_damage', name: '+% Damage', effect: 'pct_damage', bonusType: 'percent', desc: 'Increases damage dealt', costRes: 'bandit_emblem', baseCost: 30 },
        { id: 'base_accuracy', name: '+ Base Accuracy', effect: 'base_accuracy', bonusType: 'flat', desc: 'Increases hit accuracy', costRes: 'goblin_ear', baseCost: 25 },
        ...
        { id: 'crit_damage', name: '+% Crit Damage', effect: 'crit_damage', bonusType: 'percent', desc: 'Increases critical damage', costRes: 'slime_gel', baseCost: 30 },
        { id: 'crit_chance', name: '+% Crit Chance', effect: 'crit_chance', bonusType: 'percent', desc: 'Increases critical chance', costRes: 'goblin_ear', baseCost: 30 },
        { id: 'drop_rate', name: '+% Drop Rate', effect: 'drop_rate', bonusType: 'percent', desc: 'Increases loot drop rate', costRes: 'wolf_fur', baseCost: 25 },
        { id: 'strength', name: '+ Strength', effect: 'strength', bonusType: 'flat', desc: 'Increases strength', costRes: 'bandit_emblem', baseCost: 25 },
        { id: 'agility', name: '+ Agility', effect: 'agility', bonusType: 'flat', desc: 'Increases agility', costRes: 'slime_gel', baseCost: 25 },
        { id: 'magic', name: '+ Magic', effect: 'magic', bonusType: 'flat', desc: 'Increases magic', costRes: 'goblin_ear', baseCost: 25 },
        { id: 'carry_capacity', name: '+% Carrying Capacity', effect: 'carry_capacity', bonusType: 'percent', desc: 'More items per inventory slot', costRes: 'wolf_fur', baseCost: 30 },
        { id: 'gold_gain', name: '+% Gold Gain', effect: 'gold_gain', bonusType: 'percent', desc: 'Earn more gold', costRes: 'bandit_emblem', baseCost: 20 },
      ],
    },
    {
      id: 'mining', name: 'Mining Branch', icon: '⛏',
      nodes: [
        { id: 'base_mining_eff', name: '+ Base Mining Efficiency', effect: 'mining_yield', bonusType: 'flat', desc: 'Mine more ore per action', costRes: 'slime_gel', baseCost: 30 },
        { id: 'mining_carry', name: '+% Carrying Capacity', effect: 'mining_carry', bonusType: 'percent', desc: 'More ore per inventory slot', costRes: 'goblin_ear', baseCost: 25 },
        { id: 'multi_ore', name: '+% Multi-Ore Chance', effect: 'mining_multi', bonusType: 'percent', desc: 'Chance for extra ore', costRes: 'copper_bar', baseCost: 35 },
        { id: 'mining_xp', name: '+% Mining Exp Gain', effect: 'mining_xp', bonusType: 'percent', desc: 'More mining XP', costRes: 'iron_bar', baseCost: 30 },
      ],
    },
    {
      id: 'woodcutting', name: 'Woodcutting Branch', icon: '🪓',
      nodes: [
        { id: 'base_wc_eff', name: '+ Base Woodcutting Efficiency', effect: 'woodcutting_yield', bonusType: 'flat', desc: 'Chop more logs per action', costRes: 'wolf_fur', baseCost: 30 },
        { id: 'wc_carry', name: '+% Carrying Capacity', effect: 'woodcutting_carry', bonusType: 'percent', desc: 'More logs per inventory slot', costRes: 'bandit_emblem', baseCost: 25 },
        { id: 'multi_log', name: '+% Multi-Log Chance', effect: 'woodcutting_multi', bonusType: 'percent', desc: 'Chance for extra logs', costRes: 'wooden_pegs', baseCost: 35 },
        { id: 'wc_xp', name: '+% Woodcutting Exp Gain', effect: 'woodcutting_xp', bonusType: 'percent', desc: 'More woodcutting XP', costRes: 'resin', baseCost: 30 },
      ],
    },
    {
      id: 'fishing', name: 'Fishing Branch', icon: '🎣',
      nodes: [
        { id: 'base_fish_eff', name: '+ Base Fishing Efficiency', effect: 'fishing_yield', bonusType: 'flat', desc: 'Catch more fish per action', costRes: 'twine', baseCost: 30 },
        { id: 'fish_carry', name: '+% Carrying Capacity', effect: 'fishing_carry', bonusType: 'percent', desc: 'More fish per inventory slot', costRes: 'iron_nails', baseCost: 25 },
        ...
        { id: 'fish_xp', name: '+% Fishing Exp Gain', effect: 'fishing_xp', bonusType: 'percent', desc: 'More fishing XP', costRes: 'platinum_bar', baseCost: 30 },
      ],
    },
    {
